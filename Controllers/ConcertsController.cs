...
namespace FestivalCarthage.Controllers
{
    public class ConcertsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nom,Artiste,DateConcert,HeureConcert,Lieu,Prix")] Concert concert)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Artiste,DateConcert,HeureConcert,Lieu,Prix")] Concert concert)
        {
            if (id != concert.Id)
            {
                return NotFound();
